...
from app import create_app  # Assuming your sales_service has an app.py with create_app
from config import TestConfig  # Assuming you have a TestConfig in config.py
from database import db  # Assuming your sales_service has a database.py with db
